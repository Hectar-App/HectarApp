...
import { View, Text, TextInput, StyleSheet, Platform, Animated, TouchableOpacity, FlatList, TouchableHighlight, Image } from 'react-native';
                ...
                renderItem={({item, index}) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                <Image source={item.icon || false ? {uri: item.icon}:Images.greenLocationIcon} style={{width: 25, height: 25, borderRadius: 12.5}} />
                            </View>
                            <Text
