...
import {OfficesTypes} from '../Redux/OfficesRedux';
...
import {getOffices} from './OfficeSagas';
...
export default function* root() {
  yield all([
    ...
    takeLatest(
      UserTypes.FORGET_PASSWORD_VERFY_NUMBER,
      ConfirmForgetPassword,
      api,
    ),
    ...
    takeLatest(
      RealEstateTypes.GET_ADDING_AQAR_INFO,
      getAddingRealEstateInfo,
      api,
    ),
    ...
    takeLatest(
      RealEstateTypes.GET_USER_NOTIFICATION,
      getUserNotifications,
      api,
    ),
    ...
    takeLatest(
      RealEstateTypes.GET_REAL_ESTATE_DETAILS,
      getRealEstateDetails,
      api,
    ),
    takeLatest(OfficesTypes.GET_OFFICES, getOffices, api),
  ]);
}
