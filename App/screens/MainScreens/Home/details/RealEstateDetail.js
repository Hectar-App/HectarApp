...
import { Colors, CustomIcon, Fonts, Images, Metrics } from '../../../../Themes';
...
import { PropertyInfoItem } from './components/RealEstateDetail';
...
class RealEstateDetail extends React.Component {
  ...
  render() {
    const { realEstateItem, owner, like, fav, images } = this.state;
              ...
              <TouchableWithoutFeedback
                ...
                <Animated.View
                  ...
                  <View
                    ...
                    {realEstateItem.notes && (
                      <PropertyInfoItem
                        value={realEstateItem.notes}
                        label={'نبذة عن العقار: '}
                        icon={'city'}
                      />
                    )}
                    ...
                    {realEstateItem.purpose &&
                      ...
                      !shop && (
                        <PropertyInfoItem
                          value={realEstateItem.purpose.nameAr}
                    ...
                    {(realEstateItem.streetWidth ||
                      ...
                      <PropertyInfoItem
                        value={realEstateItem.streetWidth}
                        label={'عرض الشارع: '}
                        icon={'road'}
                      />
                    )}
                    ...
                    {realEstateItem.numberOfUnit && (
                      <PropertyInfoItem
                        value={realEstateItem.numberOfUnit}
                        label={'عدد الوحدات: '}
                        icon={'area'}
                      />
                    )}
