        ...
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
          <View style={{ flex: 1 }}>
            <Animated.View
              ...
              <Animated.View
                ...
                <View
                  ...
                  {/* <Animated.Text style={[Fonts.style.normal, {marginBottom: 9, fontWeight: 'normal', color: headerBackgroundColorText}]} > {realEstateItem && realEstateItem.status && realEstateItem.status.nameAr && realEstateItem.status.nameAr} </Animated.Text> */}
            ...
            <Animated.View
              ...
              // style={[styles.ballView, {position: 'absolute', width: 34, flexDirection: 'row' , borderRadius: 17, opacity, backgroundColor:'rgba(199,183,169, .50)', justifyContent:'center', alignItems: 'center', top: ifIphoneX(50, 20), left: 15, zIndex: 99999,}]}
            >
              <TouchableOpacity
                // style={[styles.ballView, {  justifyContent:'center', alignItems: 'center', zIndex: 99999, marginEnd: 0 }]}
                style={[
                  styles.ballView,
                  {
                    width: 34,
                ...
                />
                {/* <IconButton icon={'chevron-right'} color={'#fff'} style={{alignSelf:'center'}} /> */}
              </TouchableOpacity>
